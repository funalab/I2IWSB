...
from src.lib.utils.visualizer import show_loss, show_metrics, \
    show_metrics_validation, show_loss_distributed, show_loss_WSB
from src.lib.runner.tester import guidedI2ITester, I2SBTester, PaletteTester, I2IWSBTester
...
class I2IWSBTrainer(object):
    ...
    def train(self, model_G, model_D, train_iterator, validation_iterator):
        ...
        validator = I2IWSBTester(**validator_args)
