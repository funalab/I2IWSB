...
from src.lib.optimizers.optimizers import get_optimizer_WSB
from src.lib.optimizers.schedulers import get_scheduler_WSB
from src.lib.runner.get_runner_args import get_train_args_WSB
from src.lib.runner.trainer import I2IWSBTrainer
...
def main():
    ...
    optimizer_G, optimizer_D = get_optimizer_WSB(args=args, model_G=model_G, model_D=model_D)

    # Initialize an scheduler
    scheduler_G, scheduler_D = get_scheduler_WSB(args=args, optimizer_G=optimizer_G, optimizer_D=optimizer_D)
    ...
    # start train
    if str(args.model) == "i2iwsb":
        trainer = I2IWSBTrainer(**trainer_args)
    else:
