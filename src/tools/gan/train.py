...
from src.lib.models.models import get_train_model_GAN
...
from src.lib.runner.get_runner_args import get_train_args_GAN
from src.lib.runner.trainer import cWGANGPTrainer
...
def main():
    ...
    model_G, model_D = get_train_model_GAN(args=args, device=device)
    ...
    ''' Train '''
    # Initialize a runner
    trainer_args = get_train_args_GAN(args=args,
    ...
    if str(args.model) == "cWGAN-GP":
        trainer = cWGANGPTrainer(**trainer_args)
    else:
