...
def main():
    root = '/Users/morikura/Documents/Ozeki/pairedimagetoimagetranslation'
    wsb_paths = glob(f'{root}/results/wsb/trial_wellplate_epoch100_batch28/train_fold1_20240301-012459/'
                     f'test/loss/images/*/Predict/*.tif')
    gt_paths = glob(f'{root}/results/wsb/trial_wellplate_epoch100_batch28/train_fold1_20240301-012459/'
                    f'test/loss/images/*/GT/*.tif')
    i2sb_paths = glob(f'{root}/results/i2sb/trial_wellplate_epoch100_batch28/train_fold5_20240315-101422/'
                      f'test/loss/images/*/Predict/*.tif')
    guided_paths = glob(f'{root}/results/guidedI2I/trial_wellplate_epoch100_batch28/train_fold2_20240320-122149/'
                        f'test/loss/images/BR00117011__2020-11-08T19_57_47-Measurement1/Images/*/Out/*.tif')
    palette_paths = glob(f'{root}/results/palette/trial_wellplate_epoch100_batch28/train_fold3_20240324-100652/'
                         f'test/loss/images/BR00117011__2020-11-08T19_57_47-Measurement1/Images/*/Out/*.tif')
    cwgangp_paths = glob(f'{root}/results/cwgangp/trial_wellplate_epoch100_batch28/train_fold5_20240319-094042/'
                         f'test/mse/images/*/*.tif')
    print(len(wsb_paths), len(gt_paths), len(i2sb_paths), len(guided_paths), len(palette_paths), len(cwgangp_paths))
    ...
    cwgangp_dict = convert_paths_to_ch_dict(cwgangp_paths, ch_list)
    ...
    save_root = check_dir(f'{root}/notebooks/visualize_dimension_reduction')
    save_root = check_dir(f'{save_root}/resize_shape_{resize_shape[0]}-{resize_shape[1]}_GAN')
